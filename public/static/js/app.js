...
var App = function() {
    ...
    var uiHandleTheme = function() {
        ...
        jQuery('[data-toggle="theme"]').on('click', function(){
            ...
            pageLoader();
            jQuery.get(Quick.theme_url, {theme: $theme}, function (res) {
                pageLoader('hide');
                if (res.code) {
    ...
    var uiHelperCkeditor = function(){
        ...
        if (jQuery('#js-ckeditor-inline').length) {
            CKEDITOR.replace('js-ckeditor-inline');
        }
 ...
 */
function tips($msg, $type, $icon, $from, $align) {
    $type = $type || 'info';
    $from = $from || 'top';
    $align = $align || 'center';
    $enter = $type === 'success' ? 'animated bounceInDown' : 'animated shake';
