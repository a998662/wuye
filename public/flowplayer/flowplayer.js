...
(function (e) {
    ...
    var t                                                                      = !0, n                                                              = !1, r = "onreadystatechange", i                            = "DOMContentLoaded", s = "__IE8__" + Math.random(),
        o                                                                      = e.Object, u                                                        = o.defineProperty || function (e, t, n) {
            e[t] = n.value
        ...
        }, f                                                                   = o.getOwnPropertyDescriptor, l                                   = o.prototype.hasOwnProperty, c = e.Element.prototype,
        h = e.Text.prototype, p = /^[a-z]+$/, d = /loaded|complete/, v = {}, m = document.createElement("div");
...
// Flash is buggy allover
                    ...
                    var engine = {
                        ...
                        load: function (video) {
                            ...
                            if (api) {
                                ...
                                // optional conf
                                [
                                    'proxy', 'key', 'autoplay', 'preload', 'subscribe', 'live', 'loop', 'debug',
                                    'splash', 'poster', 'rtmpt'
                                ...
                                api.pollInterval = setInterval(function () {
                                    ...
                                    if (player.playing && status.time && status.time !== player.video.time) player.trigger("progress", [
                                        player, status.time
                                    ]);
            ...
            }, {"../common": 1, "../flowplayer": 31, "./embed": 2, "bean": 34, "extend-object": 39}
        ], 4 : [
            function (_dereq_, module, exports) {
                'use strict';
                var flowplayer     = _dereq_('../flowplayer')
...
// HTML5 --> Flowplayer event
                    ...
                    return self = {
                        ...
                        load: function (video) {
                            ...
                            if (support.subtitles && conf.nativesubtitles && video.subtitles && video.subtitles.length) {
                                ...
                                })) common.attr(api, 'crossorigin', 'anonymous');
                        ...
                        seek: function (time) {
                            ...
                            try {
                                ...
                                if (pausedState) bean.one(api, 'seeked', function () {
                                    api.pause();
                                });
                            } catch (ignored) {
                            }
            ...
            function (_dereq_, module, exports) {
                ...
                flowplayer(function (player, root) {
                    ...
                    }).on("unload", setClass).on('beforeseek', function (ev) {
                        setTimeout(function () {
                    ...
                    player.addCuepoint = function (cue) {
                        ...
                        if (player.cuepoints.length) cue.index = Math.max.apply(null, player.cuepoints.map(function (cue) {
                            return cue.index;
                        })) + 1;
                    ...
                    player.removeCuepoint = function (cue) {
                        if (typeof cue === 'number') cue = player.cuepoints.filter(function (c) {
                            return c.index === cue;
                        })[0];
            ...
            }, {"../common": 1, "../flowplayer": 31, "./util/clipboard": 30, "bean": 34}
        ], 12: [
            function (_dereq_, module, exports) {
                'use strict';
                /**
...
// esc button
                    ...
                    if (!metaKeyPressed && el.ready) {
                        ...
                        var handled = (function () {
                            switch (key) {
                                ...
                                case 190:
                                    el.seekTo();
                                    return true;                                     // to last seek position
                                case 32:
                                    el.toggle();
                                    return true;                                      // spacebar
                                case 70:
                                    if (conf.fullscreen) el.fullscreen();
                                    return true;              // toggle fullscreen
                                case 77:
                                    el.mute();
                                    return true;                                        // mute
                                case 81:
                                    el.unload();
                                    return true;                                      // unload/stop
                            }
                        })();
            ...
            function (_dereq_, module, exports) {
                ...
                flowplayer(function (player, root) {
                    ...
                    player.play = function (i) {
                        ...
                        if (typeof i === 'number' && i === player.video.index) return player.seek(0, function () {
                            player.resume();
                        });
            ...
            }, {"../common": 1, "../flowplayer": 31, "./resolve": 21, "bean": 34, "extend-object": 39}
        ], 20: [
            function (_dereq_, module, exports) {
                var flowplayer = _dereq_('../flowplayer')
                    , common   = _dereq_('../common')
            ...
            }, {"../common": 1, "../flowplayer": 31, "bean": 34, "extend-object": 39}
        ], 23: [
            function (_dereq_, module, exports) {
                'use strict';
                var flowplayer = _dereq_('../flowplayer'),
                    ...
                    p.bind("seek", function (e, api, time) {
                        ...
                        (p.cuepoints || []).forEach(function (cue, index) {
                            ...
                            if (entry && currentPoint != index) {
                                if (time >= cue.time && (!entry.endTime || time <= entry.endTime)) p.trigger("cuepoint", [
                                    p, cue
                                ]);
            ...
            }, {"../common": 1, "../flowplayer": 31, "./subtitles/parser": 24, "bean": 34}
        ], 24: [
            function (_dereq_, module, exports) {
...
// display seconds in hh:mm:ss format
         ...
         <div class="fp-controls">\
            ...
            }, {"../common": 1, "../flowplayer": 31, "./ui/bar-slider": 28, "./ui/slider": 29, "bean": 34, "buffer": 35}
        ], 28: [
            function (_dereq_, module, exports) {
            ...
            function (_dereq_, module, exports) {
                ...
                extend(flowplayer, {
                    ...
                    engine: function (name) {
                        return flowplayer.engines.filter(function (e) {
                            return e.engineName === name;
                        })[0];
                    },
                ...
                if (typeof window.jQuery !== 'undefined') {
                    ...
                    var videoTagConfig = function (videoTag) {
                        ...
                        $.each(['autoplay', 'loop', 'preload', 'poster'], function (i, key) {
                            ...
                            if (val !== undefined && [
                                'autoplay', 'poster'
                            ].indexOf(key) !== -1) conf[key] = val ? val : true;
...
//Have to add fullscreen last
                ...
                flowplayer(function (e, o) {
                    ...
                    var l                                       = function (e, o) {
                        ...
                        }, n = e.conf, t = flowplayer.common, p = t.createElement,
                        i                                       = n.swf.indexOf("flowplayer.org") && n.e && o.getAttribute("data-origin"),
                        f                                       = i ? a(i) : t.hostname(), s          = (document, n.key);
                    if ("file:" == location.protocol && (f = "localhost"), e.load.ed = 1, n.hostname = f, n.origin = i || location.href, i && l(o, "is-embedded"), "string" == typeof s && (s = s.split(/,\s*/)), s && "function" == typeof key_check && key_check(s, f)) {
                        if (n.logo) {
                            var d = t.find(".fp-player", o)[0], c = n.logo.href || "", h = n.logo.src || n.logo,
                                m                                                        = p("a", {className: "fp-logo", href: c});
                            i && (m.href = m.href || i), n.embed && n.embed.popup && (m.target = "_blank");
                            var y = p("img", {src: h});
                            m.appendChild(y), (d || o).appendChild(m)
                        }
                    } else {
                  /*      var m = p("a", {href: "https://flowplayer.com/hello/?from=player"}),
                        ...
                        7 !== g && (d || o).appendChild(u), e.on("pause resume finish unload ready", function (e, a) {
                            var l = -1;
                            if (a.video.src) for (var n = [
                                ["org", "flowplayer", "drive"], ["org", "flowplayer", "my"],
                                ["org", "flowplayer", "cdn"], ["com", "flowplayer", "cdn"]
                            ...
                            if (/pause|resume/.test(e.type) && "flash" != a.engine.engineName && 4 != l && 5 != l) {
                                var p = {
                                    ...
                                    height         : "20px"
                                 //   backgroundImage: "url(" + [
                                 //       ".png", "logo", "/", ".net", ".cloudfront", "d32wqyuo10o653", "//", "https:"
                                  //  ].reverse().join("") + ")"
                                };
